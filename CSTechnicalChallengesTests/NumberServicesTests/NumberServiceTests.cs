...
namespace CSTechnicalChallengesTests.NumberServicesTests
{
	public class NumberServiceTests
	{
		...
		public void SumOfIntegerArray(long[] integerToSum, long expected)
		{
		...
		[InlineData("15 * 5 + 5 / 2", 77)]
		public void EvaluateMathExpressions(string mathExpression, long expected)
		{
			INumberService number = new NumberService();
		...
		[Theory]
		[InlineData("5 + 5 / 0")]
		public void EvaluateDivisonByZero(string mathExpression)
		{
			INumberService number = new NumberService();
		...
		[InlineData("552")]
		[InlineData("5 + / 2")]
		public void EvaluateWrongExpressionFormat(string mathExpression)
		{
			INumberService number = new NumberService();
